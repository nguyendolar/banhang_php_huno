<h2 class="text-center p-3 text-success">Danh Sách Loại Sản Phẩm</h2>
			...
			while ($row=$dt->fetch()) {
				...
				<tr>
					...
					<td>
						...
						<a href="sources/product_type/action.php?id=<?php echo $row['type_id'] ?>" class="navbar-link"><i style="color: red" class="fas fa-minus-circle"></i></a>
					</td>
