...
<?php
  ...
  $id=isset($_GET["id"])?$_GET["id"]:"";
   ...
   $row2=$dt->fetch();
?>
<h2 class="text-center p-3 text-success">Cập Nhật Đơn Hàng</h2>
<form action="sources/order/action.php?id=<?php echo $row2['id'] ?>" method="post" enctype="multipart/form-data">
